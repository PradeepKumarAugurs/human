...
<section class="campus-tour padding-sm"> 
    <div class="container text-center">
        <div class="isotopeFilters">
            <ul class="gallery-filter clearfix remove">
                ...
                <?php if(count($all_category)) { foreach($all_category as $row) { ?>
                <li><a href="#" data-filter=".<?=$row['category']?>" data-category="<?=$row['category']?>" class="get_gallery_images"><?=$row['category']?></a></li>
                <?php } }?>
