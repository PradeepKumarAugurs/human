            ...
            <div class="scroll-sidebar">
                <div class="user-profile">
                    <div class="profile-img">
                        <img alt="image path not found" src="<?= base_url()?>frontend/images/pic_hrpws/LOGO-HRPWS copy.png" title=""/>
                    </div>
                </div>
...
-->
                        ...
                        <li> 
                            <a class="waves-effect waves-dark" href="<?= site_url('admin/add_category')?>" aria-expanded="false"><i class="fa fa-tag"></i>&nbsp;&nbsp;<span class="hide-menu">Category</span></a>
                        </li>


                        <li> <a class="waves-effect waves-dark" href="<?= site_url('admin/manage_slider')?>" aria-expanded="false"><i class="fa fa-list"></i>&nbsp;&nbsp;<span class="hide-menu">Manage Slider</span></a>
                        </li> 
