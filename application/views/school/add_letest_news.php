                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Enter ID Card &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;font-size: 13px;">*</span></label>
                                    <input type="text" name="letest_news" class="form-control" required >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Upload &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;font-size: 13px;">* &nbsp;</span></label>
                                    <input type="file" class="form-control images" name="news_file"  required>
                                </div>
                            </div>
                        </div>
                    </div>
